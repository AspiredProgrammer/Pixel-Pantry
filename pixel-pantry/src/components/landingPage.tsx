    ...
    return (
        <section>
            <div className='flex justify-center items-center  wallpaper-bg overflow-hidden min-h-screen relative'>
                <div
                    className='w-full flex justify-center items-center px-8 px-10 py-10 relative z-10'
                >
                    {/* left side hero text */}
                    <div className='flex flex-col justify-center max-w-md mr-10 bg-amber-900/95 backdrop-blur-sm p-6 rounded-xl w-[1200px] h-[400px]' style={{ marginRight: '-100px', zIndex: 20 }}>
